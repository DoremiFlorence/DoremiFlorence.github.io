window.portfolioData = {
    ...
    projects: [
        {
            tags: ["MACHINE LEARNING", "<span class=\"mono-tag accent-red\">QSHINE 2023</span>"],
        ...
        {
            tags: ["QUANT FINTECH", "<span class=\"mono-tag accent-red\">ALGORITHM</span>"],
            title: "Stock Behavior Simulation",
            image: "assets/finflow.png",
            leadText: "Advanced financial simulation leveraging RL to optimize dynamic investment strategies.",
            detailsHtml: `
                <p><strong>Logic:</strong> Built feature factors using CRSP/Compustat data. Applied REINFORCE algorithm to adapt strategies over shifting market conditions.</p>
                <p><strong>Stack:</strong> Python, Reinforcement Learning, Financial Data Modeling.</p>
            `
        },
        {
